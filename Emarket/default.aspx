<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Emarket._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-color:#385be2; border-radius:5px;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label1" runat="server" Text="Tüm Ürünler" ForeColor="White" Font-Bold="True" Font-Size="15pt"></asp:Label></div>
    
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EmarketDBConnectionString %>" SelectCommand="SELECT [id], [ad], [resim], [birim_fiyat] FROM [urun] "></asp:SqlDataSource>
...
<td runat="server" />
            ...
            <ItemTemplate>
                <td runat="server" style="text-align:center; font-size: 9px; border:solid 2px #efeded;">
                    <asp:Image ID="Image1" runat="server" Height="205px" ImageUrl='<%# Eval("resim") %>' Width="224px" />
                    <br />
