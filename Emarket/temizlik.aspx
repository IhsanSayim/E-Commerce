<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="temizlik.aspx.cs" Inherits="Emarket.temizlik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%-- <asp:DataList ID="dl_temizlik" runat="server" OnSelectedIndexChanged="dl_temizlik_SelectedIndexChanged" Width="100%">
        <ItemTemplate>
            <table class="auto-style5">
                <tr>
                    <td class="auto-style6">
                        &nbsp;<asp:Image ID="img_temizlik" runat="server" Height="130px" ImageAlign="Middle" ImageUrl='<%# Eval("resim") %>' Width="130px" />
     ...
     <div style="background-color:#385be2; border-radius:5px;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label1" runat="server" Text="Temizlik Ürünleri" ForeColor="White" Font-Bold="True" Font-Size="15pt"></asp:Label></div>
...
<td runat="server" />
            ...
            <ItemTemplate>
                <td runat="server" style="text-align:center; font-size: 9px; border:solid 2px #efeded;">
                    ...
                    <br />
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="10pt" Text="Adet:"></asp:Label>
                    &nbsp;
